...
$result = mysqli_query($conn, "SELECT UPPER(RegNr) as RegNr, DATE_FORMAT(Kuupaev, '%d.%m.%Y') AS Date, Omanik, Kogus, Hooaeg FROM Rehvi_Ladu ORDER BY Kuupaev DESC LIMIT 51");
$rows = [];
